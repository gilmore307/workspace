...
In `trading-main`, registry operating guidance lives in `docs/08_registry.md`; concrete entries still live in SQL and kind boundaries still live under `registry/kinds/`.
