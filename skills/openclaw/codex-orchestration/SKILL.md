...
When scripts need the file locator for that canonical prompt, prefer the registered `CODEX_TASK_PROMPT_TEMPLATE_SCRIPT_ADDRESS` entry instead of hardcoding the template path.
