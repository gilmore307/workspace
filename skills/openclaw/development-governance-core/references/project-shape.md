...
For fixed-location repository docs such as `README.md` and `docs/00_scope.md` through `docs/06_memory.md`, keep the markdown templates in the relevant skills instead of registering them in `universal-catalog`.
